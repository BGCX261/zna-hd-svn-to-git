...
namespace ZNA
{
    ...
    /// </summary>
    public class ZObject : Microsoft.Xna.Framework.GameComponent
    {
        ...
        /// <param name="stepSize">the maximum step that the ZObject will take to get to the target point</param>
